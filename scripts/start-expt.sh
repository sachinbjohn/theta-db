...
for q in $queries; do
  ...
  for e in $expts; do
    ...
    sed -e "s/QUERYNAME/$q/g" -e "s/EXPNAME/${ql}-smart/g" -e 's/TESTFLAG/16/g' -e 's/TIMEMIN/15/g' -e "s/FOLDERNAME/$current/g" -e "s/EXPNUM/$e/g" Docker/expt-sql.yaml.template >Docker/expt-sql-$q-smart-e$e.yaml
    ...
    sed -e "s/QUERYNAME/$q/g" -e "s/EXPNAME/${ql}-range/g" -e 's/TESTFLAG/4/g' -e 's/TIMEMIN/15/g' -e "s/FOLDERNAME/$current/g" -e "s/EXPNUM/$e/g" Docker/expt-sql.yaml.template >Docker/expt-sql-$q-range-e$e.yaml
    ...
    sed -e "s/QUERYNAME/$q/g" -e "s/EXPNAME/${ql}-merge/g" -e 's/TESTFLAG/8/g' -e 's/TIMEMIN/15/g' -e "s/FOLDERNAME/$current/g" -e "s/EXPNUM/$e/g" Docker/expt-sql.yaml.template >Docker/expt-sql-$q-merge-e$e.yaml
