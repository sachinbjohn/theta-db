...
sed -e 's/EXPNAME/naive/g' -e 's/TESTFLAG/1/g' -e 's/TIMEMIN/20/g' -e "s/FOLDERNAME/$current/g" Docker/expt-scala.yaml.template > Docker/expt-scala-naive.yaml
...
sed -e 's/EXPNAME/dbt/g' -e 's/TESTFLAG/2/g' -e 's/TIMEMIN/20/g' -e "s/FOLDERNAME/$current/g" Docker/expt-scala.yaml.template > Docker/expt-scala-dbt.yaml
...
sed -e 's/EXPNAME/range/g' -e 's/TESTFLAG/4/g' -e 's/TIMEMIN/60/g' -e "s/FOLDERNAME/$current/g" Docker/expt-scala.yaml.template > Docker/expt-scala-range.yaml
...
sed -e 's/EXPNAME/merge/g' -e 's/TESTFLAG/8/g' -e 's/TIMEMIN/60/g' -e "s/FOLDERNAME/$current/g" Docker/expt-scala.yaml.template > Docker/expt-scala-merge.yaml
