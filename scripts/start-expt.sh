...
sed -e "s/QUERYNAME/$q/g" -e "s/EXPNAME/${ql}-naive/g" -e 's/TESTFLAG/1/g' -e 's/TIMEMIN/10/g' -e "s/FOLDERNAME/$current/g" Docker/expt-sql.yaml.template > Docker/expt-sql-$q-naive.yaml
...
sed -e "s/QUERYNAME/$q/g" -e "s/EXPNAME/${ql}-smart/g" -e 's/TESTFLAG/16/g' -e 's/TIMEMIN/10/g' -e "s/FOLDERNAME/$current/g" Docker/expt-sql.yaml.template > Docker/expt-sql-$q-smart.yaml
...
#sed -e "s/QUERYNAME/$q/g" -e "s/EXPNAME/${ql}-range/g" -e 's/TESTFLAG/4/g' -e 's/TIMEMIN/30/g' -e "s/FOLDERNAME/$current/g" Docker/expt-scala.yaml.template > Docker/expt-scala-$q-range.yaml
 sed -e "s/QUERYNAME/$q/g" -e "s/EXPNAME/${ql}-range/g" -e 's/TESTFLAG/4/g' -e 's/TIMEMIN/10/g' -e "s/FOLDERNAME/$current/g" Docker/expt-sql.yaml.template > Docker/expt-sql-$q-range.yaml
...
#sed -e "s/QUERYNAME/$q/g" -e "s/EXPNAME/${ql}-merge/g" -e 's/TESTFLAG/8/g' -e 's/TIMEMIN/30/g' -e "s/FOLDERNAME/$current/g" Docker/expt-scala.yaml.template > Docker/expt-scala-$q-merge.yaml
 sed -e "s/QUERYNAME/$q/g" -e "s/EXPNAME/${ql}-merge/g" -e 's/TESTFLAG/8/g' -e 's/TIMEMIN/10/g' -e "s/FOLDERNAME/$current/g" Docker/expt-sql.yaml.template > Docker/expt-sql-$q-merge.yaml
...
kubectl create -f Docker/expt-sql-$q-smart.yaml
