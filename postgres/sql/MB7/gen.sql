...
FROM aggbids r, groups_b2 UNION SELECT DISTINCT s.price AS ineqkey1, s.time AS gbykey1
FROM aggbids s
...
create type cube_b2_aggtype as (gbykey1 double precision,aggb2 double precision);
...
create type rt_b2_aggtype as (gbykey1 double precision,aggb2 double precision);
