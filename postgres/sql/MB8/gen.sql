...
create procedure construct_rt_bS(height_d1 integer, height_d2 integer)
    language plpgsql as
$$
declare
    bf_d1 integer := 2;
...
create function lookup_rt_bS(_outer record, height_d1 integer, height_d2 integer) returns SETOF rt_bS_aggtype
    language plpgsql as
$$
declare
...
create procedure construct_rt_bR(height_d1 integer, height_d2 integer)
    language plpgsql as
$$
declare
    bf_d1 integer := 2;
...
create function lookup_rt_bR(_outer record, height_d1 integer, height_d2 integer) returns SETOF rt_bR_aggtype
    language plpgsql as
$$
declare
    _agg       double precision;
